...
function Cabin({ cabin }: CabinProps): ReactElement {
  return (
    <div
      className="grid grid-cols-[3fr_4fr] gap-20 border border-primary-800 py-3 
        px-10 mb-24"
    >
      ...
      <div>
        <h3
          className="text-accent-100 font-black text-7xl mb-5 bg-primary-950 
            p-6 pb-1 w-[150%] translate-x-[-254px] "
        >
          Cabin {cabin.name}
        </h3>
